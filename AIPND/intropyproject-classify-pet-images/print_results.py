...
def print_results(results_dic, results_stats_dic, model,
    ...
    print('')
    any_dogs_misclassified = results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != \
                             results_stats_dic['n_images']
    if print_incorrect_dogs and any_dogs_misclassified:
